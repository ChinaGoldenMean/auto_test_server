package com.auto.test.config.apiggs;
 ...
 */
public class CostomPostmanRender implements ProjectRender {
    private static final Logger log = LoggerFactory.getLogger(CostomPostmanRender.class);
    
    public CostomPostmanRender() {
    }
    ...
    public Postman build(Project project) {
    ...
    public Item build(Section section) {
        Item item = new Item();
